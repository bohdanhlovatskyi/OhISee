...
\pagebreak
\begin{abstract}
SLAM or Simultaneous Localization and Mapping - problem of constructing a map of unknown environment simultaneously tracking the object's location. Such algorithms utilize the data obtained from sensors, such as video camera, lidar etc to construct a 3-D model of the nearby objects. They are used in variety of fields: autonomous driving and robots, augmented reality and much more. The algorithms that rely on video data are referred to as Visual SLAM. They obtain the valuable information by means of Computer Vision and different techniques of Signal Processing. We implemented a variation of such algorithm - Monocular SLAM as a part of our linear algebra project. It tracks position of object basing on input video stream from a single camera installed on the object. Source code: ~\cite{GitHub}.
\end{abstract}
...
\bibitem{Testing_Data} \texttt{http://www.cvlibs.net/datasets/kitti/eval_odometry.php}

\bibitem{ORB_SLAM} \texttt{http://webdiis.unizar.es/~raulmur/MurMontielTardosTRO15.pdf}

\bibitem{Camera_Calibration} \texttt{https://www.microsoft.com/en-us/research/wp-content/uploads/2016/02/tr98-71.pdf} 

\bibitem{Self_Calibration} \texttt{https://users.aalto.fi/~kannalj1/publications/wacv2016.pdf}

\bibitem{Slambook} \texttt{https://github.com/gaoxiang12/slambook-en}

\bibitem{OpenVSLAM} \texttt{https://arxiv.org/pdf/1910.01122.pdf}

\bibitem{GeneralFramework} \texttt{https://arxiv.org/pdf/1902.07995.pdf}
